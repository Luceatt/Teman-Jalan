...
<!-- Location Map Modal -->
<div id="location-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Select Location on Map</h3>
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
            function(position) {
                ...
                // You could also show a map here for visual confirmation
...
document.getElementById('create-place-form').addEventListener('submit', function(e) {
    ...
    // Re-enable after a delay (in case of quick submission)
    setTimeout(() => {
