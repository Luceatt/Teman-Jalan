    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Aktivitas Baru</h1>
                    <p class="text-gray-600">Untuk rundown: {{ $rundown->title }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('rundowns.activities.store', $rundown->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Deskripsikan aktivitas ini">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="notes"
                              ...
                              placeholder="Catatan tambahan untuk aktivitas ini">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
