    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">{{ __('Edit Activity') }}</h1>
                    <p class="text-gray-600">{{ __('For rundown') }}: {{ $activity->rundown->title }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('activities.update', $activity->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="{{ __('Describe this activity') }}">{{ old('description', $activity->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="notes"
                              ...
                              placeholder="{{ __('Additional notes for this activity') }}">{{ old('notes', $activity->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
