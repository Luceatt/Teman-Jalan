    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h1 class="text-xl font-bold text-gray-900">Tambah Pengeluaran Baru</h1>
            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="paid_by_user_id" id="paid_by_user_id" required
                            ...
                            @foreach($participants as $participant)
                                <option value="{{ $participant->user->id }}" {{ (old('paid_by_user_id') == $participant->user->id || Auth::id() == $participant->user->id) ? 'selected' : '' }}>
