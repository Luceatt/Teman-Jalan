...
namespace App\Features\EventPlanning\Models;

use Database\Factories\Features\EventPlanning\Models\ActivityFactory;
...
class Activity extends Model
{
    ...
    {
        return $this->belongsTo(\App\Features\Location\Models\Place::class, 'place_id');
    }
